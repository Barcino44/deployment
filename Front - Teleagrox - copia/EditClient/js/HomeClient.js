...
async function getClientData() {
    ...
    let response = await fetch(`https://back-production-5d7a.up.railway.app:8080/admin/clients/${clientId}`, {
        method: 'GET',
        headers: {
...
async function editClient() {
    ...
    let response = await fetch(`https://back-production-5d7a.up.railway.app:8080/admin/clients/update/${clientId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
...
let deviceIds = deviceTF.value
   ...
   let response = await fetch(`https://back-production-5d7a.up.railway.app:8080/admin/clients/addDevicetoClient/${clientId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
