...
async function getDevicesAndRender() {
	...
	try {
		const response = await fetch(`https://back-production-5d7a.up.railway.app:8080/client/get/devices/${clientId}`);
...
async function getDeviceStatus() {
	const response = await fetch(`https://back-production-5d7a.up.railway.app:8080/client/device/get/status/${clientId}`);
